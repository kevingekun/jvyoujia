...
class UcenterController extends WmallController
{
    ...
    public function delOrder()
    {
        ...
        M('mall_order_shop')->where($map)->del();
        if ($order) {
...
//            }
    ...
    public function orderDetail()
    {
        ...
        $res = $order
            ->alias('o')
            ->field('o.order_number as order_number,o.is_normal as type_invoice,o.total_price as total_price,o.pay_style as pay_style,o.create_time as create_time,o.cart_data as cart_data,o.real_price as real_price,o.invoice as invoice_status,u.realname as name,u.phone as phone,a.region_id as region_id,a.full_address as full_address,a.mobile as mobile,c.money_cut as money_cut,g.image as image,g.name as good_name,g.price as price,i.plain_title as title,i.vat_taxpaper_ident as payer_indet,i.vat_deposit_bank as bank,i.vat_bank_account as bank_account,s.routes as routes')
